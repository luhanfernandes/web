...
public class PessoaClienteService {
    ...
    public Pessoa registrar(PessoaClienteRequestDTO pessoaClienteRequestDTO){
        ...
        //emailService.enviarEmailTexto(objetoNovo.getEmail(), "Cadastro na loja myWeb", "Seja bem vindo! O cadastro foi realizado com sucesso. Brevemente você receberá a senha de acesso via email.");
        ...
        emailService.enviarEmailTemplate(objetoNovo.getEmail(), "Cadastro na web loja", proprMap);
        return objetoNovo;
